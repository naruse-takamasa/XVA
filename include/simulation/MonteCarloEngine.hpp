...
private:
    ...
    void simulateBlock(std::size_t pathStart,
                       std::size_t pathEnd,
                       const std::vector<InterestRateSwap>& swaps,
                       const TimeGrid& grid,
                       Matrix& pathValues,
