...
Real CVACalculator::compute(const SimulationResult& result, const YieldCurve& disc) const {
...
Real CVACalculator::cs01(const SimulationResult& result, const YieldCurve& disc,
                         Real bpShift) const {
