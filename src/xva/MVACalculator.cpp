...
MVACalculator::MVACalculator(Real spread)
    : imFundingSpread_(spread) {}

// MVA = -s_im * sum_i IM(t_i) * D(t_i) * dt_i
Real MVACalculator::compute(const SimulationResult& result,
...
Real MVACalculator::fundingSpreadSensitivity(
